...
function createShadowMesh(device, entity, type, color = Color.WHITE, templateOpts) {
	...
	for (let i = 0; i < shadow.length; i++) {
		geom.colors.push(shadow[i] * color.r * 0xFF, shadow[i] * color.g * 0xFF, shadow[i] * color.b * 0xFF, color.a * 0xFF);
	}
...
export { AxisArrow, AxisBoxCenter, AxisBoxLine, AxisDisk, AxisPlane, AxisShape, AxisSphereCenter };
