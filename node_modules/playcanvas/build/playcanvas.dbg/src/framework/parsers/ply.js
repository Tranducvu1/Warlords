        ...
        for (let j = 0; j < element.properties.length; ++j) {
          ...
          if (property.storage) {
            switch (property.type) {
              case 'char':
                property.storage[c] = streamBuf.getInt8();
                break;
              case 'uchar':
                property.storage[c] = streamBuf.getUint8();
                break;
              case 'short':
                property.storage[c] = streamBuf.getInt16();
                break;
              case 'ushort':
                property.storage[c] = streamBuf.getUint16();
                break;
              case 'int':
                property.storage[c] = streamBuf.getInt32();
                break;
              case 'uint':
                property.storage[c] = streamBuf.getUint32();
                break;
              case 'float':
                property.storage[c] = streamBuf.getFloat32();
                break;
              case 'double':
                property.storage[c] = streamBuf.getFloat64();
                break;
            }
          } else {
