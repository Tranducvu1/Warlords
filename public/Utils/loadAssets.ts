...
export function loadAssets(app: pc.Application): Record<string, pc.Asset> {
    const assets = {
        ...
        zombiedeath: new pc.Asset('animation_zombiedeath', 'animation', { url: '../animation/zombiedeath.glb' }),
        zombieattack: new pc.Asset('animation_zombieattack', 'animation', { url: '../animation/zombieattack.glb' }),
        ...
        runningshooting: new pc.Asset('animation_runningshooting', 'animation', { url: '../animation/runningshooting.glb' }),
